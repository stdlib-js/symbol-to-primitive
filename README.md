...
```javascript
ToPrimitiveSymbol = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/symbol-to-primitive@v0.1.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/symbol-to-primitive@v0.1.2-umd/browser.js"></script>
```
