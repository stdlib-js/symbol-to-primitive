...
```javascript
ToPrimitiveSymbol = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/symbol-to-primitive@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ToPrimitiveSymbol = require( 'path/to/vendor/umd/symbol-to-primitive/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/symbol-to-primitive@v0.1.0-umd/browser.js"></script>
```
